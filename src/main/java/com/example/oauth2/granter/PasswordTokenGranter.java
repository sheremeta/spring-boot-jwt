...
import com.example.oauth2.exception.MfaRequiredException;
...
public class PasswordTokenGranter extends AbstractTokenGranter {
    ...
    private final TargetAuthorityEnhancer targetAuthorityEnhancer;
    ...
    public PasswordTokenGranter(AuthorizationServerEndpointsConfigurer endpointsConfigurer, AuthenticationManager authenticationManager,
                                MfaService mfaService, TargetAuthorityEnhancer targetAuthorityEnhancer) {
        ...
        this.targetAuthorityEnhancer = targetAuthorityEnhancer;
    }
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        try {
            ...
            targetAuthorityEnhancer.targetAuthorities(userAuth.getAuthorities());
        ...
        if (userAuth != null && userAuth.isAuthenticated()) {
            ...
            if (mfaService.isEnabled(username)) {
                userAuth = new UsernamePasswordAuthenticationToken(username, password, singleton(PRE_AUTH));
